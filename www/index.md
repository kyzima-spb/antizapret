...
*   [RoboVPS](https://www.robovps.biz/?ref=39155)
    ...
    *   ChatGPT открывается, но не выдает токен

*   [HOSTING RUSSIA](https://hosting-russia.ru/?p=37512)
    *   период использования: 17.10.2023 - по сегодня
    *   ChatGPT открывается, но не выдает токен в обоих локациях

*   [аéза](https://aeza.net/?ref=451381)
    *   тестировал 21.02.2024 локации США и Лондон для выдачи токена ChatGPT
    *   почасовая оплата
    *   ChatGPT выдал токен в локации Лондон, в США - отказался
